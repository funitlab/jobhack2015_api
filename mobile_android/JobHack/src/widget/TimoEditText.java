...
public class TimoEditText extends EditText{
	public enum fonts {
	...
	public TimoEditText(Context context) {
		super(context);

		applyCustomFont(context, null);
	}

	public TimoEditText(Context context, AttributeSet attrs) {
		super(context, attrs);

		applyCustomFont(context, attrs);
	}

	public TimoEditText(Context context, AttributeSet attrs, int defStyle) {
