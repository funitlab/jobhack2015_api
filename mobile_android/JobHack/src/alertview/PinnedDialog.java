...
public class PinnedDialog {
	...
	public static void showPinnedDialog(final Context context,
			final String title, final JobList item, ImageLoader imageLoader,
			final PinnedDialogInterface inter) {
	...
	public interface PinnedDialogInterface {
		void onApply(JobList job);
		void onRecommend(JobList job);
		void onUnPin(JobList job);
		void onDismiss();
	}
