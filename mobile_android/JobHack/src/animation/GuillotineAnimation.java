...
import util.ActionBarInterpolator;
import util.GuillotineInterpolator;
import interfaces.GuillotineListener;
 ...
 */
@SuppressLint("NewApi") public class GuillotineAnimation {
    ...
    @SuppressLint("NewApi") private ObjectAnimator buildOpeningAnimation() {
