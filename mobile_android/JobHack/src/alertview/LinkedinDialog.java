...
import com.funitlab.jobhack.R.id;
import com.funitlab.jobhack.R.layout;
...
public class LinkedinDialog extends Dialog {
	...
	private void setWebView() {
		LinkedinDialog.oAuthService = LinkedInOAuthServiceFactory.getInstance()
				.createLinkedInOAuthService(Common.LINKEDIN_CONSUMER_KEY,
		...
		LinkedinDialog.liToken = LinkedinDialog.oAuthService
				.getOAuthRequestToken(Common.OAUTH_CALLBACK_URL);
	...
	class HelloWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			if (url.contains(Common.OAUTH_CALLBACK_URL)) {
